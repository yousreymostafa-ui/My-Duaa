const CACHE='my-duaa-v24';
const ASSETS=['./','./index.html','./styles.css','./app.js','./v16.js','./v17.js','./v18.js','./v19.js','./v20.js','./v21.js','./v22.js','./v23.js','./manifest.json','./logo.svg','./app-icon.png','./duaa-header.jpg'];
...
async function combinedApp(req){
  ...
  const files=['./v16.js','./v17.js','./v18.js','./v19.js','./v20.js','./v21.js','./v22.js','./v23.js'];
...
self.addEventListener('fetch',e=>{
  ...
  if(u.hostname==='api.aladhan.com'){e.respondWith(fetch(e.request));return}
