const CACHE='my-duaa-v21';
const ASSETS=['./','./index.html','./styles.css','./app.js','./v16.js','./v17.js','./v18.js','./v19.js','./v20.js','./v21.js','./manifest.json','./logo.svg','./app-icon.png'];
...
async function combinedApp(req){
  ...
  let base,p16,p17,p18,p19,p20,p21;
  ...
  try{p21=await fetch('./v21.js',{cache:'no-store'})}catch{p21=await cache.match('./v21.js')}
  ...
  const p21Text=p21?await p21.text():'';
  return new Response(baseText+'\n'+p16Text+'\n'+p17Text+'\n'+p18Text+'\n'+p19Text+'\n'+p20Text+'\n'+p21Text,{headers:{'Content-Type':'application/javascript; charset=utf-8','Cache-Control':'no-cache'}});
}
