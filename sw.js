const CACHE='my-duaa-v19';
const ASSETS=['./','./index.html','./styles.css','./app.js','./v16.js','./v17.js','./v18.js','./v19.js','./manifest.json','./logo.svg','./app-icon.png'];
...
async function combinedApp(req){
  ...
  return new Response(baseText+'\n'+p16Text+'\n'+p17Text+'\n'+p18Text+'\n'+p19Text,{headers:{'Content-Type':'application/javascript; charset=utf-8','Cache-Control':'no-cache'}});
}
